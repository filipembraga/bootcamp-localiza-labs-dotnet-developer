using Bogus; //Biblioteca dos fakes
...
namespace Vaquinha.Tests.Common.Fixtures
{
    ...
    public class EnderecoFixture
    {
        ...
        {
            var endereco = new Faker().Address; //Gera endereço válido conforme regras abaixos
            ...
            return faker.Generate(); //Retorna endereço válido gerado
        }
