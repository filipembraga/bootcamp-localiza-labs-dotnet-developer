...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact] //Primeiro teste de unidade
        ...
        public void Doacao_DadosPessoaisInvalidos_DoacaoInvalida()
        {
            ...
            var doacao = _doacaoFixture.DoacaoValida(EMAIL_INVALIDO); //Testando e-mail inválido
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
        ...
        [Theory] //Executa testes com todos os cenários (valores) abaixo.
        [InlineData(0)]
        [InlineData(-10)]
        [InlineData(-5)]
        [InlineData(-10.20)]
